...
Docker → `docs/context/docker-patterns.md` · CI/CD → `docs/context/cicd-patterns.md`.
...
Kafka · Validation · Pagination · Jackson · Records · Testing · Docker · Dependencies
...
- Do not penalise absent aspirational infrastructure (Kafka/gateway) the repo has no module for — see CLAUDE.md repo-maturity note.

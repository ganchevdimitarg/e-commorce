        ...
        flows = @OAuthFlows(
                authorizationCode = @OAuthFlow(
                        ...
                        scopes = {
                                ...
                                @OAuthScope(name = "profile.read", description = "with this scope, the user can access every get request"),
                                @OAuthScope(name = "profile.write", description = "with this scope, the user can access every post, put and delete request"),
                        }
                )
        )
)
